...
from _alf_common import call_anthropic, supabase_get, supabase_post, make_handler_base, strip_article_boilerplate, verify_draft
...
class handler(_Base):
    def do_POST(self):
        ...
        self._respond(200, {
            "ok": True, "draft_id": draft_id, "title": title,
